...
namespace Nes
{
    namespace Core
    {
        ...
        public:
            ...
            inline Data Peek_M_Rom(Address); static Data Peek_Rom(void*,Address);
            inline void Poke_M_Nop(Address,Data); static void Poke_Nop(void*,Address,Data);
                    ...
                    if (Log::Available())
                    {
                        switch (Crc32::Compute( rom, SIZE_8K ))
                        {
                            ...
                            case TWINSYSTEM_ID:
                                ...
                                Log::Flush( "Fds: BIOS ROM ok" "\n" );
                                break;
                                
                            default:
                                
                                Log::Flush( "Fds: warning, unknown BIOS ROM!" "\n" );
                                break;
                        }
                    }
                }
        ...
        Data Fds::Bios::Peek_Rom(void* p_,Address i_) { return static_cast<Fds::Bios*>(p_)->Peek_M_Rom(i_); } inline Data Fds::Bios::Peek_M_Rom(Address address)
        {
            return rom[address - 0xE000];
        }
        
        void Fds::Bios::Poke_Nop(void* p_,Address i_,Data j_) { static_cast<Fds::Bios*>(p_)->Poke_M_Nop(i_,j_); } inline void Fds::Bios::Poke_M_Nop(Address,Data)
        {
        }
        
        inline byte* Fds::Disks::Sides::operator [] (uint i) const
        {
            (__builtin_expect(!(!!(i < count)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 150, "!!(i < count)") : (void)0);
        ...
        void Fds::Reset(const bool hard)
        {
            ...
            (
             cpu,
             disks.current == Disks::EJECTED ? __null : disks.sides[disks.current],
        ...
        void Fds::LoadState(State::Loader& state)
        {
            ...
            if (saveDisks[0] != ~0U)
            {
                ...
                if (saveDisks[0] & 0x1U)
                {
                    if (((InsertDisk( saveDisks[1] / 2, saveDisks[1] % 2 )) < Nes::RESULT_OK))
            ...
            adapter.Mount
            (
             disks.current != Disks::EJECTED && !disks.mounting ? disks.sides[disks.current] : __null,
             disks.writeProtected
             );
        }
        ...
        void Fds::SaveState(State::Saver& state,const dword baseChunk) const
        {
            ...
            if (adapter.Dirty() || !state.Internal())
            {
                ...
                for (uint i=0; i < disks.sides.count; ++i)
                {
                    const byte* const __restrict__ src = disks.sides[i];
        ...
        Data Fds::Peek_Nop(void* p_,Address i_) { return static_cast<Fds*>(p_)->Peek_M_Nop(i_); } inline Data Fds::Peek_M_Nop(Address)
        {
            return OPEN_BUS;
        }
        
        void Fds::Poke_Nop(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_Nop(i_,j_); } inline void Fds::Poke_M_Nop(Address,Data)
        {
        }
        
        void Fds::Poke_4023(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4023(i_,j_); } inline void Fds::Poke_M_4023(Address,Data data)
        {
            io.ctrl = data;
        }
        
        void Fds::Poke_4026(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4026(i_,j_); } inline void Fds::Poke_M_4026(Address,Data data)
        {
            io.port = data;
        }
        
        Data Fds::Peek_4033(void* p_,Address i_) { return static_cast<Fds*>(p_)->Peek_M_4033(i_); } inline Data Fds::Peek_M_4033(Address)
        {
            ((void)0);
            return io.port & Io::BATTERY_CHARGED;
        }
        
        Data Fds::Peek_4040(void* p_,Address i_) { return static_cast<Fds*>(p_)->Peek_M_4040(i_); } inline Data Fds::Peek_M_4040(Address address)
        {
            return sound.ReadWaveData( address );
        }
        
        void Fds::Poke_4040(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4040(i_,j_); } inline void Fds::Poke_M_4040(Address address,Data data)
        {
            sound.WriteWaveData( address, data );
        }
        
        void Fds::Poke_4080(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4080(i_,j_); } inline void Fds::Poke_M_4080(Address,Data data)
        {
            sound.WriteReg0( data );
        }
        
        void Fds::Poke_4082(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4082(i_,j_); } inline void Fds::Poke_M_4082(Address,Data data)
        {
            sound.WriteReg1( data );
        }
        
        void Fds::Poke_4083(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4083(i_,j_); } inline void Fds::Poke_M_4083(Address,Data data)
        {
            sound.WriteReg2( data );
        }
        
        void Fds::Poke_4084(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4084(i_,j_); } inline void Fds::Poke_M_4084(Address,Data data)
        {
            sound.WriteReg3( data );
        }
        
        void Fds::Poke_4085(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4085(i_,j_); } inline void Fds::Poke_M_4085(Address,Data data)
        {
            sound.WriteReg4( data );
        }
        
        void Fds::Poke_4086(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4086(i_,j_); } inline void Fds::Poke_M_4086(Address,Data data)
        {
            sound.WriteReg5( data );
        }
        
        void Fds::Poke_4087(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4087(i_,j_); } inline void Fds::Poke_M_4087(Address,Data data)
        {
            sound.WriteReg6( data );
        }
        
        void Fds::Poke_4088(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4088(i_,j_); } inline void Fds::Poke_M_4088(Address,Data data)
        {
            sound.WriteReg7( data );
        }
        
        void Fds::Poke_4089(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4089(i_,j_); } inline void Fds::Poke_M_4089(Address,Data data)
        {
            sound.WriteReg8( data );
        }
        
        void Fds::Poke_408A(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_408A(i_,j_); } inline void Fds::Poke_M_408A(Address,Data data)
        {
            sound.WriteReg9( data );
        }
        
        Data Fds::Peek_4090(void* p_,Address i_) { return static_cast<Fds*>(p_)->Peek_M_4090(i_); } inline Data Fds::Peek_M_4090(Address)
        {
            return sound.ReadVolumeGain();
        }
        
        Data Fds::Peek_4092(void* p_,Address i_) { return static_cast<Fds*>(p_)->Peek_M_4092(i_); } inline Data Fds::Peek_M_4092(Address)
        {
        ...
        __attribute__((noinline)) void Fds::Disks::Sides::Load() const
        {
            (__builtin_expect(!(!!(!dirty)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 657, "!!(!dirty)") : (void)0);
        ...
        writeProtected (false)
        {
            if (Log::Available())
            {
                ...
                for (uint i=0; i < sides.count; ++i)
                {
                    ...
                    if (((Unit::Drive::Analyze( sides[i], data )) >= Nes::RESULT_OK))
                    {
                        dword disksize = 0;
        ...
        Result Fds::Unit::Drive::Analyze(const byte* __restrict__ src,Api::Fds::DiskData& dst)
        {
            try
            {
                idword i = SIDE_SIZE;
                ...
                for (uint block=~0U, files=0; i; )
                {
                    ...
                    else if (block == BLOCK_DATA)
                    {
                        ...
                        (__builtin_expect(!(!!(files)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 897, "!!(files)") : (void)0);
        ...
        inline void Fds::Unit::Drive::Write(uint reg)
        {
            ctrl = reg;
        ...
        {
            (__builtin_expect(!(!!(io && !count)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 951, "!!(io && !count)") : (void)0);
        ...
        void Fds::Adapter::SaveState(State::Saver& state) const
        {
            ...
            {
                const uint headPos = ((unit.drive.headPos) < (SIDE_SIZE) ? (unit.drive.headPos) : (SIDE_SIZE));
        ...
        inline void Fds::Adapter::Write(uint reg)
        {
            Update();
        ...
        Data Fds::Adapter::Peek_Nop(void* p_,Address i_) { return static_cast<Fds::Adapter*>(p_)->Peek_M_Nop(i_); } inline Data Fds::Adapter::Peek_M_Nop(Address)
        {
            return OPEN_BUS;
        }
        
        void Fds::Adapter::Poke_Nop(void* p_,Address i_,Data j_) { static_cast<Fds::Adapter*>(p_)->Poke_M_Nop(i_,j_); } inline void Fds::Adapter::Poke_M_Nop(Address,Data)
        {
        }
        
        void Fds::Adapter::Poke_4020(void* p_,Address i_,Data j_) { static_cast<Fds::Adapter*>(p_)->Poke_M_4020(i_,j_); } inline void Fds::Adapter::Poke_M_4020(Address,Data data)
        {
            Update();
            unit.timer.latch = (unit.timer.latch & 0xFF00U) | (data << 0);
        }
        
        void Fds::Adapter::Poke_4021(void* p_,Address i_,Data j_) { static_cast<Fds::Adapter*>(p_)->Poke_M_4021(i_,j_); } inline void Fds::Adapter::Poke_M_4021(Address,Data data)
        {
            Update();
            unit.timer.latch = (unit.timer.latch & 0x00FFU) | (data << 8);
        }
        
        void Fds::Adapter::Poke_4022(void* p_,Address i_,Data j_) { static_cast<Fds::Adapter*>(p_)->Poke_M_4022(i_,j_); } inline void Fds::Adapter::Poke_M_4022(Address,Data data)
        {
            Update();
        ...
        void Fds::Adapter::Poke_4024(void* p_,Address i_,Data j_) { static_cast<Fds::Adapter*>(p_)->Poke_M_4024(i_,j_); } inline void Fds::Adapter::Poke_M_4024(Address,Data data)
        {
            Update();
        ...
        Data Fds::Adapter::Peek_4030(void* p_,Address i_) { return static_cast<Fds::Adapter*>(p_)->Peek_M_4030(i_); } inline Data Fds::Adapter::Peek_M_4030(Address)
        {
            Update();
        ...
        Data Fds::Adapter::Peek_4032(void* p_,Address i_) { return static_cast<Fds::Adapter*>(p_)->Peek_M_4032(i_); } inline Data Fds::Adapter::Peek_M_4032(Address)
        {
            Update();
            
            (__builtin_expect(!(!!(unit.drive.status & uint(OPEN_BUS))), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 1395, "!!(unit.drive.status & uint(OPEN_BUS))") : (void)0);
        ...
        Data Fds::Ram::Peek_Ram(void* p_,Address i_) { return static_cast<Fds::Ram*>(p_)->Peek_M_Ram(i_); } inline Data Fds::Ram::Peek_M_Ram(Address address)
        {
            return mem[address - 0x6000];
        }
        
        void Fds::Ram::Poke_Ram(void* p_,Address i_,Data j_) { static_cast<Fds::Ram*>(p_)->Poke_M_Ram(i_,j_); } inline void Fds::Ram::Poke_M_Ram(Address address,Data data)
        {
            mem[address - 0x6000] = data;
        }
        
        void Fds::Poke_4025(void* p_,Address i_,Data j_) { static_cast<Fds*>(p_)->Poke_M_4025(i_,j_); } inline void Fds::Poke_M_4025(Address,Data data)
        {
            adapter.Write( data );
            ppu.SetMirroring( (data & CTRL1_NMT_HORIZONTAL) ? Ppu::NMT_HORIZONTAL : Ppu::NMT_VERTICAL );
        }
        
        Data Fds::Peek_4031(void* p_,Address i_) { return static_cast<Fds*>(p_)->Peek_M_4031(i_); } inline Data Fds::Peek_M_4031(Address)
        {
        ...
        void Fds::Sound::Envelope::LoadState(State::Loader& state)
        {
            ...
            output = ((gain) < (GAIN_MAX) ? (gain) : (GAIN_MAX));
        }
        ...
        {
            (__builtin_expect(!(!!(output == ((gain) < (GAIN_MAX) ? (gain) : (GAIN_MAX)))), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 1522, "!!(output == ((gain) < (GAIN_MAX) ? (gain) : (GAIN_MAX)))") : (void)0);
            return output;
        }
        ...
        inline void Fds::Sound::Envelope::Clock()
        {
        ...
        inline dword Fds::Sound::GetModulation() const
        {
        ...
        {
            (__builtin_expect(!(!!(modulator.active == CanModulate() && bool(active) == CanOutput())), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstFds.cpp", 2029, "!!(modulator.active == CanModulate() && bool(active) == CanOutput())") : (void)0);
