                    ...
                    if (emulator.extPort->NumPorts() > 2)
                    {
                        ...
                        else switch (type)
                        {
                            case UNCONNECTED:
                                ...
                                else if (__null != (old = new (std::nothrow) Core::Input::Device( emulator.cpu )))
                                {
                                    old = &emulator.extPort->Connect( port, *old );
                                }
                                else
                            ...
                            case PAD4:
                                ...
                                if (__null != (old = new (std::nothrow) Core::Input::Pad( emulator.cpu, uint(type) - PAD1 )))
                                {
                                    old = &emulator.extPort->Connect( port, *old );
                                }
                                else
