...
namespace Nes
{
    namespace Api
    {
        ...
        Result Cheats::GameGenieEncode(const Code& code,char (&characters)[9]) throw()
        {
        ...
        Result Cheats::GameGenieDecode(const char* const characters,Code& code) throw()
        {
            if (characters == __null)
                return RESULT_ERR_INVALID_PARAM;
        ...
        Result Cheats::ProActionRockyEncode(const Code& code,char (&characters)[9]) throw()
        {
        ...
        Result Cheats::ProActionRockyDecode(const char* const characters,Code& code) throw()
        {
            if (characters == __null)
                return RESULT_ERR_INVALID_PARAM;
