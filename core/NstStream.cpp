...
namespace Nes
{
    namespace Core
    {
        namespace Stream
        {
            ...
            dword In::AsciiToC(char* __restrict__ dst,const byte* __restrict__ src,dword length)
            {
            ...
            {
                (__builtin_expect(!(!!(dst && size)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstStream.cpp", 202, "!!(dst && size)") : (void)0);
