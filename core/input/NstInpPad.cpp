...
namespace Nes
{
    namespace Core
    {
        namespace Input
        {
            ...
            {
                (__builtin_expect(!(!!(i < 4)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/input/NstInpPad.cpp", 44, "!!(i < 4)") : (void)0);
                
                typedef char Nestopia_assertion_at_line_51[(( Api::Input::PAD2 - Api::Input::PAD1 ) == 1 && ( Api::Input::PAD3 - Api::Input::PAD1 ) == 2 && ( Api::Input::PAD4 - Api::Input::PAD1 ) == 3) ? 1 : -1];
