...
namespace Nes
{
    namespace Core
    {
        ...
        dataRecorder (__null)
        {
            typedef char Nestopia_assertion_at_line_70[(Revision::PPU_RP2C02 - Api::Cartridge::PPU_RP2C02 == 0 && Revision::PPU_RP2C03B - Api::Cartridge::PPU_RP2C03B == 0 && Revision::PPU_RP2C03G - Api::Cartridge::PPU_RP2C03G == 0 && Revision::PPU_RP2C04_0001 - Api::Cartridge::PPU_RP2C04_0001 == 0 && Revision::PPU_RP2C04_0002 - Api::Cartridge::PPU_RP2C04_0002 == 0 && Revision::PPU_RP2C04_0003 - Api::Cartridge::PPU_RP2C04_0003 == 0 && Revision::PPU_RP2C04_0004 - Api::Cartridge::PPU_RP2C04_0004 == 0 && Revision::PPU_RC2C03B - Api::Cartridge::PPU_RC2C03B == 0 && Revision::PPU_RC2C03C - Api::Cartridge::PPU_RC2C03C == 0 && Revision::PPU_RC2C05_01 - Api::Cartridge::PPU_RC2C05_01 == 0 && Revision::PPU_RC2C05_02 - Api::Cartridge::PPU_RC2C05_02 == 0 && Revision::PPU_RC2C05_03 - Api::Cartridge::PPU_RC2C05_03 == 0 && Revision::PPU_RC2C05_04 - Api::Cartridge::PPU_RC2C05_04 == 0 && Revision::PPU_RC2C05_05 - Api::Cartridge::PPU_RC2C05_05 == 0 && Revision::PPU_RP2C07 - Api::Cartridge::PPU_RP2C07 == 0) ? 1 : -1];
            try
            {
                ImageDatabase::Handle databaseHandle = __null;
                ...
                if (context.database && databaseHandle)
                {
                    ...
                    if (context.database->Encrypted(databaseHandle))
                    {
                        ...
                        Log::Flush( "Cartridge: file is encrypted!" "\n" );
                    }
                    ...
                    if (context.database->InputEx(databaseHandle) == ImageDatabase::INPUT_EX_TURBOFILE)
                    {
                        ...
                        Log::Flush( "Cartridge: Turbo File storage device present" "\n" );
                    }
                }
                ...
                if (Cartridge::QueryExternalDevice( EXT_DIP_SWITCHES ))
                    Log::Flush( "Cartridge: DIP Switches present" "\n" );
            }
            catch (...)
            {
                Destroy();
        ...
        {
            (__builtin_expect(!(!!(port < Api::Input::NUM_CONTROLLERS)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstCartridge.cpp", 202, "!!(port < Api::Input::NUM_CONTROLLERS)") : (void)0);
        ...
        bool Cartridge::PowerOff()
        {
            ...
            {
                if (mapper)
                    mapper->Sync( Mapper::EVENT_POWER_OFF, __null );
        ...
        {
            (__builtin_expect(!(!!(info.setup.wrkRamBacked+info.setup.wrkRam == Size())), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstCartridge.cpp", 466, "!!(info.setup.wrkRamBacked+info.setup.wrkRam == Size())") : (void)0);
            
            uint i = (preserveBattery ? info.setup.wrkRamBacked : 0);
            
            for (const uint n=((Size()) < (Ines::TRAINER_BEGIN) ? (Size()) : (Ines::TRAINER_BEGIN)), openBus=info.setup.wrkRamAuto; i < n; ++i)
                (*this)[i] = openBus ? (0x6000 + i) >> 8 : GARBAGE;
            
            if (i < Ines::TRAINER_END && info.setup.trainer)
                i = Ines::TRAINER_END;
            
            for (const uint n=((Size()) < (0x2000) ? (Size()) : (0x2000)), openBus=info.setup.wrkRamAuto; i < n; ++i)
                (*this)[i] = openBus ? (0x6000 + i) >> 8 : GARBAGE;
        ...
        {
            (__builtin_expect(!(!!(info.setup.wrkRamBacked+info.setup.wrkRam == Size())), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstCartridge.cpp", 485, "!!(info.setup.wrkRamBacked+info.setup.wrkRam == Size())") : (void)0);
            
            if (info.setup.wrkRamBacked >= MIN_BATTERY_SIZE)
            {
                if (!file.Load( File::LOAD_BATTERY, Mem(), info.setup.wrkRamBacked ))
                    Log::Flush( "Cartridge: warning, save file and W-RAM size mismatch!" "\n" );
            }
        }
        
        void Cartridge::Wrk::Save(const Info& info) const
        {
            (__builtin_expect(!(!!(info.setup.wrkRamBacked+info.setup.wrkRam == Size())), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstCartridge.cpp", 496, "!!(info.setup.wrkRamBacked+info.setup.wrkRam == Size())") : (void)0);
        ...
        {
            mapper->Sync( Mapper::EVENT_END_FRAME, __null );
