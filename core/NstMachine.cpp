    ...
    namespace Core
    {
        ...
        Result Machine::PowerOff(Result result)
        {
            if (state & Api::Machine::ON)
            {
                ...
                if (image && !image->PowerOff() && ((result) >= Nes::RESULT_OK))
        ...
        {
            (__builtin_expect(!(!!((state & (Api::Machine::GAME|Api::Machine::ON)) > Api::Machine::ON)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstMachine.cpp", 291, "!!((state & (Api::Machine::GAME|Api::Machine::ON)) > Api::Machine::ON)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((state & (Api::Machine::GAME|Api::Machine::ON)) > Api::Machine::ON)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/NstMachine.cpp", 323, "!!((state & (Api::Machine::GAME|Api::Machine::ON)) > Api::Machine::ON)") : (void)0);
        ...
        void Machine::Poke_4016(void* p_,Address i_,Data j_) { static_cast<Machine*>(p_)->Poke_M_4016(i_,j_); } inline void Machine::Poke_M_4016(Address,Data data)
        {
            extPort->Poke( data );
            expPort->Poke( data );
        }
        
        Data Machine::Peek_4016(void* p_,Address i_) { return static_cast<Machine*>(p_)->Peek_M_4016(i_); } inline Data Machine::Peek_M_4016(Address)
        {
            return OPEN_BUS | extPort->Peek(0) | expPort->Peek(0);
        }
        
        void Machine::Poke_4017(void* p_,Address i_,Data j_) { static_cast<Machine*>(p_)->Poke_M_4017(i_,j_); } inline void Machine::Poke_M_4017(Address,Data data)
        {
            cpu.GetApu().WriteFrameCtrl( data );
        }
        
        Data Machine::Peek_4017(void* p_,Address i_) { return static_cast<Machine*>(p_)->Peek_M_4017(i_); } inline Data Machine::Peek_M_4017(Address)
        {
