...
namespace Nes
{
    namespace Core
    {
        ...
        entries (__null)
        {
            typedef char Nestopia_assertion_at_line_71[(Cart::MIRROR_HORIZONTAL == 0 && Cart::MIRROR_VERTICAL == 1 && Cart::MIRROR_FOURSCREEN == 2 && Cart::MIRROR_ZERO == 3 && Cart::MIRROR_ONE == 4 && Cart::MIRROR_CONTROLLED == 5) ? 1 : -1];
        }
        ...
        Result ImageDatabase::Load(StdStream input)
        {
            ...
            try
            {
                ...
                Entry* __restrict__ it = new Entry [numEntries];
                entries = it;
