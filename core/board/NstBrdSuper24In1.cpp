...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Super24In1::Poke_5FF0(void* p_,Address i_,Data j_) { static_cast<Super24In1*>(p_)->Poke_M_5FF0(i_,j_); } inline void Super24In1::Poke_M_5FF0(Address,Data data)
            {
                if (exRegs[0] != data)
                {
                    exRegs[0] = data;
            ...
            void Super24In1::Poke_5FF1(void* p_,Address i_,Data j_) { static_cast<Super24In1*>(p_)->Poke_M_5FF1(i_,j_); } inline void Super24In1::Poke_M_5FF1(Address,Data data)
            {
                if (exRegs[1] != (data << 1))
                {
                    exRegs[1] = data << 1;
            ...
            void Super24In1::Poke_5FF2(void* p_,Address i_,Data j_) { static_cast<Super24In1*>(p_)->Poke_M_5FF2(i_,j_); } inline void Super24In1::Poke_M_5FF2(Address,Data data)
            {
                if (exRegs[2] != (data << 2))
                {
                    exRegs[2] = data << 2;
