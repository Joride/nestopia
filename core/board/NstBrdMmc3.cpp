...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Mmc3::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_8000(i_,j_); } inline void Mmc3::Poke_M_8000(Address,Data data)
            {
            ...
            void Mmc3::Poke_8001(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_8001(i_,j_); } inline void Mmc3::Poke_M_8001(Address,Data data)
            {
            ...
            void Mmc3::Poke_A001(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_A001(i_,j_); } inline void Mmc3::Poke_M_A001(Address,Data data)
            {
                regs.ctrl1 = data;
            ...
            void Mmc3::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_C000(i_,j_); } inline void Mmc3::Poke_M_C000(Address,Data data)
            {
                irq.Update();
                irq.unit.SetLatch( data );
            }
            
            void Mmc3::Poke_C001(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_C001(i_,j_); } inline void Mmc3::Poke_M_C001(Address,Data)
            {
                irq.Update();
                irq.unit.Reload();
            }
            
            void Mmc3::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_E000(i_,j_); } inline void Mmc3::Poke_M_E000(Address,Data)
            {
                irq.Update();
                irq.unit.Disable( cpu );
            }
            
            void Mmc3::Poke_E001(void* p_,Address i_,Data j_) { static_cast<Mmc3*>(p_)->Poke_M_E001(i_,j_); } inline void Mmc3::Poke_M_E001(Address,Data)
            {
                irq.Update();
                irq.unit.Enable();
            }
