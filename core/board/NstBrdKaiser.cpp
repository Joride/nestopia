...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Kaiser::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_8000(i_,j_); } inline void Kaiser::Poke_M_8000(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = (irq.unit.latch & 0xFFF0) | (data & 0xF) << 0;
            }
            
            void Kaiser::Poke_9000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_9000(i_,j_); } inline void Kaiser::Poke_M_9000(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = (irq.unit.latch & 0xFF0F) | (data & 0xF) << 4;
            }
            
            void Kaiser::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_A000(i_,j_); } inline void Kaiser::Poke_M_A000(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = (irq.unit.latch & 0xF0FF) | (data & 0xF) << 8;
            }
            
            void Kaiser::Poke_B000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_B000(i_,j_); } inline void Kaiser::Poke_M_B000(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = (irq.unit.latch & 0x0FFF) | (data & 0xF) << 12;
            }
            
            void Kaiser::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_C000(i_,j_); } inline void Kaiser::Poke_M_C000(Address,Data data)
            {
                irq.Update();
            ...
            void Kaiser::Poke_D000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_D000(i_,j_); } inline void Kaiser::Poke_M_D000(Address,Data)
            {
                irq.Update();
                irq.ClearIRQ();
            }
            
            void Kaiser::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_E000(i_,j_); } inline void Kaiser::Poke_M_E000(Address,Data data)
            {
                ctrl = data;
            }
            
            void Kaiser::Poke_F000(void* p_,Address i_,Data j_) { static_cast<Kaiser*>(p_)->Poke_M_F000(i_,j_); } inline void Kaiser::Poke_M_F000(Address address,Data data)
            {
                {
