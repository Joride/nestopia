...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Vrc7::Poke_9010(void* p_,Address i_,Data j_) { static_cast<Vrc7*>(p_)->Poke_M_9010(i_,j_); } inline void Vrc7::Poke_M_9010(Address,Data data)
            {
                sound.SelectReg( data );
            }
            
            void Vrc7::Poke_9030(void* p_,Address i_,Data j_) { static_cast<Vrc7*>(p_)->Poke_M_9030(i_,j_); } inline void Vrc7::Poke_M_9030(Address,Data data)
            {
                sound.WriteReg( data );
            }
            
            void Vrc7::Poke_E008(void* p_,Address i_,Data j_) { static_cast<Vrc7*>(p_)->Poke_M_E008(i_,j_); } inline void Vrc7::Poke_M_E008(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = data;
            }
            
            void Vrc7::Poke_F000(void* p_,Address i_,Data j_) { static_cast<Vrc7*>(p_)->Poke_M_F000(i_,j_); } inline void Vrc7::Poke_M_F000(Address,Data data)
            {
                irq.Toggle( data );
            }
            
            void Vrc7::Poke_F008(void* p_,Address i_,Data j_) { static_cast<Vrc7*>(p_)->Poke_M_F008(i_,j_); } inline void Vrc7::Poke_M_F008(Address,Data)
            {
                irq.Toggle();
            }
            ...
            {
                (__builtin_expect(!(!!(i < AMP_SIZE)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 502, "!!(i < AMP_SIZE)") : (void)0);
                return amp[i];
            }
            
            inline uint Vrc7::Sound::Tables::GetPitch(uint i) const
            {
                (__builtin_expect(!(!!(i < PITCH_SIZE)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 508, "!!(i < PITCH_SIZE)") : (void)0);
                return pitch[i];
            }
            
            inline uint Vrc7::Sound::Tables::GetTotalLevel(uint frequency,uint block,uint volume,uint tone) const
            {
                (__builtin_expect(!(!!((frequency >> 5) < 16 && block < 8 && volume < TL_SIZE && tone < 4)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 514, "!!((frequency >> 5) < 16 && block < 8 && volume < TL_SIZE && tone < 4)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!((frequency >> 8) < 2 && block < 8 && rate < 2)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 520, "!!((frequency >> 8) < 2 && block < 8 && rate < 2)") : (void)0);
                return sl[frequency >> 8][block][rate];
            }
            
            inline uint Vrc7::Sound::Tables::GetLog(uint egOut) const
            {
                (__builtin_expect(!(!!(egOut < LIN2LOG_SIZE)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 526, "!!(egOut < LIN2LOG_SIZE)") : (void)0);
                return lin2log[egOut];
            }
            
            inline dword Vrc7::Sound::Tables::GetAttack(uint tone,uint pos) const
            {
                (__builtin_expect(!(!!(tone < 16 && pos < 16)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 532, "!!(tone < 16 && pos < 16)") : (void)0);
                return adr[0][tone][pos];
            }
            
            inline dword Vrc7::Sound::Tables::GetDecay(uint tone,uint pos) const
            {
                (__builtin_expect(!(!!(tone < 16 && pos < 16)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 538, "!!(tone < 16 && pos < 16)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!(frequency < 512 && block < 8 && tone < 16)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 554, "!!(frequency < 512 && block < 8 && tone < 16)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!(form < 2 && pgOut < WAVE_SIZE && wave[form][pgOut] + egOut < DB2LIN_SIZE)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 560, "!!(form < 2 && pgOut < WAVE_SIZE && wave[form][pgOut] + egOut < DB2LIN_SIZE)") : (void)0);
                return db2lin[wave[form][pgOut] + egOut];
            }
            
            void Vrc7::Sound::OpllChannel::UpdateEgPhase(const Tables& tables,const uint i)
            {
                (__builtin_expect(!(!!(i < NUM_SLOTS)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 566, "!!(i < NUM_SLOTS)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!(i < NUM_SLOTS)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 610, "!!(i < NUM_SLOTS)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!(i < NUM_SLOTS)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 616, "!!(i < NUM_SLOTS)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!(i < NUM_SLOTS)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdVrc7.cpp", 622, "!!(i < NUM_SLOTS)") : (void)0);
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg0(const uint data,const Tables& tables)
            {
                patch.custom[0] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg1(const uint data,const Tables& tables)
            {
                patch.custom[1] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg2(const uint data,const Tables& tables)
            {
                patch.custom[2] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg3(const uint data)
            {
                patch.custom[3] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg4(const uint data,const Tables& tables)
            {
                patch.custom[4] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg5(const uint data,const Tables& tables)
            {
                patch.custom[5] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg6(const uint data,const Tables& tables)
            {
                patch.custom[6] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg7(const uint data,const Tables& tables)
            {
                patch.custom[7] = data;
            ...
            inline void Vrc7::Sound::OpllChannel::WriteReg8(const uint data,const Tables& tables)
            {
                frequency = (frequency & (uint(REG9_FRQ_HI) << 8)) | data;
                Update( tables );
            }
            
            inline void Vrc7::Sound::OpllChannel::WriteReg9(const uint data,const Tables& tables)
            {
            ...
            inline void Vrc7::Sound::OpllChannel::WriteRegA(uint data,const Tables& tables)
            {
            ...
            inline Vrc7::Sound::Sample Vrc7::Sound::OpllChannel::GetSample(const uint pitch,const uint amp,const Tables& tables)
            {
