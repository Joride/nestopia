...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Fk23C::Poke_5001(void* p_,Address i_,Data j_) { static_cast<Fk23C*>(p_)->Poke_M_5001(i_,j_); } inline void Fk23C::Poke_M_5001(Address address,Data data)
            {
            ...
            void Fk23C::Poke_Prg(void* p_,Address i_,Data j_) { static_cast<Fk23C*>(p_)->Poke_M_Prg(i_,j_); } inline void Fk23C::Poke_M_Prg(Address address,Data data)
            {
                if (exRegs[0] & 0x40U)
                {
