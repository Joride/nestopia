...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void S8259::Poke_4100(void* p_,Address i_,Data j_) { static_cast<S8259*>(p_)->Poke_M_4100(i_,j_); } inline void S8259::Poke_M_4100(Address,Data data)
            {
                ctrl = data;
            }
            
            void S8259::Poke_4101(void* p_,Address i_,Data j_) { static_cast<S8259*>(p_)->Poke_M_4101(i_,j_); } inline void S8259::Poke_M_4101(Address,Data data)
            {
                regs[ctrl & 0x7] = data;
