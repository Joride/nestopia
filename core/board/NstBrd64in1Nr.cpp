...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Bmc64In1Nr::Poke_5000(void* p_,Address i_,Data j_) { static_cast<Bmc64In1Nr*>(p_)->Poke_M_5000(i_,j_); } inline void Bmc64In1Nr::Poke_M_5000(Address address,Data data)
            {
                regs[address & 0x3] = data;
                Update();
            }
            
            void Bmc64In1Nr::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Bmc64In1Nr*>(p_)->Poke_M_8000(i_,j_); } inline void Bmc64In1Nr::Poke_M_8000(Address,Data data)
            {
                regs[3] = data;
                Update();
            }
