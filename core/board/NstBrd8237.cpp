...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void Unl8237::Poke_5000(void* p_,Address i_,Data j_) { static_cast<Unl8237*>(p_)->Poke_M_5000(i_,j_); } inline void Unl8237::Poke_M_5000(Address,Data data)
            {
                if (exRegs[0] != data)
                {
                    exRegs[0] = data;
            ...
            void Unl8237::Poke_5001(void* p_,Address i_,Data j_) { static_cast<Unl8237*>(p_)->Poke_M_5001(i_,j_); } inline void Unl8237::Poke_M_5001(Address,Data data)
            {
                data = data << 6 & 0x100;
            ...
            void Unl8237::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Unl8237*>(p_)->Poke_M_8000(i_,j_); } inline void Unl8237::Poke_M_8000(Address,Data data)
            {
                SetMirroringHV( data >> 7 | data );
            }
            
            void Unl8237::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Unl8237*>(p_)->Poke_M_A000(i_,j_); } inline void Unl8237::Poke_M_A000(Address,Data data)
            {
            ...
            void Unl8237::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Unl8237*>(p_)->Poke_M_C000(i_,j_); } inline void Unl8237::Poke_M_C000(Address,Data data)
            {
                if (exRegs[2])
                {
                    exRegs[2] = false;
            ...
            void Unl8237::Poke_F000(void* p_,Address i_,Data j_) { static_cast<Unl8237*>(p_)->Poke_M_F000(i_,j_); } inline void Unl8237::Poke_M_F000(Address,Data data)
            {
