...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            void TaitoX::Poke_7EF0_0(void* p_,Address i_,Data j_) { static_cast<TaitoX*>(p_)->Poke_M_7EF0_0(i_,j_); } inline void TaitoX::Poke_M_7EF0_0(Address,Data data)
            {
                SwapChr( 0x0000, data );
            }
            
            void TaitoX::Poke_7EF0_1(void* p_,Address i_,Data j_) { static_cast<TaitoX*>(p_)->Poke_M_7EF0_1(i_,j_); } inline void TaitoX::Poke_M_7EF0_1(Address,Data data)
            {
                SwapChr( 0x0000, data );
                nmt.SwapBanks<SIZE_1K,0x0000>( data >> 7, data >> 7 );
            }
            
            void TaitoX::Poke_7EF1_0(void* p_,Address i_,Data j_) { static_cast<TaitoX*>(p_)->Poke_M_7EF1_0(i_,j_); } inline void TaitoX::Poke_M_7EF1_0(Address,Data data)
            {
                SwapChr( 0x0800U, data );
            }
            
            void TaitoX::Poke_7EF1_1(void* p_,Address i_,Data j_) { static_cast<TaitoX*>(p_)->Poke_M_7EF1_1(i_,j_); } inline void TaitoX::Poke_M_7EF1_1(Address,Data data)
            {
                SwapChr( 0x0800, data );
