    ...
    namespace Core
    {
        namespace Boards
        {
            ...
            public:
                ...
                void Load(const byte* __restrict__ in)
                {
                    std::memcpy( mem, in, SIZE );
                }
                
                void Save(byte* __restrict__ out) const
                {
            ...
            {
                (__builtin_expect(!(!!(bit <= 1)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdBandai.cpp", 247, "!!(bit <= 1)") : (void)0);
            ...
            {
                (__builtin_expect(!(!!(bit <= 1)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdBandai.cpp", 350, "!!(bit <= 1)") : (void)0);
            ...
            private:
                ...
                inline void Hook_M_Transfer(); static void Hook_Transfer(void*);
            ...
            :
            x24C01 (t == TYPE_DATACH || t == TYPE_LZ93D50_E2401 ? new X24C0X<128> : __null),
            x24C02 (t == TYPE_DATACH || t == TYPE_LZ93D50_E2402 ? new X24C0X<256> : __null)
            {
            }
            ...
            irq (c.cpu),
            datach (t == TYPE_DATACH ? new DatachJointSystem(c.cpu) : __null),
            eeprom (t == TYPE_DATACH || t == TYPE_LZ93D50_E2401 || t == TYPE_LZ93D50_E2402 ? new Eeprom(t) : __null),
            type (t)
            {
                if (eeprom)
                    eeprom->Load();
            ...
            {
                (__builtin_expect(!(!!(IsTransferring() && cycles != Cpu::CYCLE_MAX)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/board/NstBrdBandai.cpp", 847, "!!(IsTransferring() && cycles != Cpu::CYCLE_MAX)") : (void)0);
            ...
            bool Bandai::DatachJointSystem::SubTransfer(cstring const string,uint length,byte* __restrict__ output)
            {
            ...
            void Bandai::DatachJointSystem::Hook_Transfer(void* p_) { static_cast<Bandai::DatachJointSystem*>(p_)->Hook_M_Transfer(); } inline void Bandai::DatachJointSystem::Hook_M_Transfer()
            {
            ...
            Data Bandai::Peek_6000_A1(void* p_,Address i_) { return static_cast<Bandai*>(p_)->Peek_M_6000_A1(i_); } inline Data Bandai::Peek_M_6000_A1(Address)
            {
                return eeprom->x24C01->Read();
            }
            
            Data Bandai::Peek_6000_A2(void* p_,Address i_) { return static_cast<Bandai*>(p_)->Peek_M_6000_A2(i_); } inline Data Bandai::Peek_M_6000_A2(Address)
            {
                return eeprom->x24C02->Read();
            }
            
            Data Bandai::Peek_6000_C(void* p_,Address i_) { return static_cast<Bandai*>(p_)->Peek_M_6000_C(i_); } inline Data Bandai::Peek_M_6000_C(Address)
            {
                return datach->GetData() | (eeprom->x24C01->Read() & eeprom->x24C02->Read());
            }
            
            void Bandai::Poke_8000_B(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_8000_B(i_,j_); } inline void Bandai::Poke_M_8000_B(Address,Data data)
            {
                data = data << 4 & 0x10;
                prg.SwapBanks<SIZE_16K,0x0000>( data | (prg.GetBank<SIZE_16K,0x0000>() & 0x0F), data | 0xF );
            }
            
            void Bandai::Poke_8008_B(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_8008_B(i_,j_); } inline void Bandai::Poke_M_8008_B(Address,Data data)
            {
                prg.SwapBank<SIZE_16K,0x0000>( (prg.GetBank<SIZE_16K,0x0000>() & 0x10) | (data & 0x0F) );
            }
            
            void Bandai::Poke_8000_C(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_8000_C(i_,j_); } inline void Bandai::Poke_M_8000_C(Address address,Data data)
            {
            ...
            void Bandai::Poke_800A(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_800A(i_,j_); } inline void Bandai::Poke_M_800A(Address,Data data)
            {
                irq.Update();
            ...
            void Bandai::Poke_800B(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_800B(i_,j_); } inline void Bandai::Poke_M_800B(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = (irq.unit.latch & 0xFF00) | data << 0;
            }
            
            void Bandai::Poke_800C(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_800C(i_,j_); } inline void Bandai::Poke_M_800C(Address,Data data)
            {
                irq.Update();
                irq.unit.latch = (irq.unit.latch & 0x00FF) | data << 8;
            }
            
            void Bandai::Poke_800D_A1(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_800D_A1(i_,j_); } inline void Bandai::Poke_M_800D_A1(Address,Data data)
            {
                eeprom->x24C01->Set( data & 0x20, data & 0x40 );
            }
            
            void Bandai::Poke_800D_A2(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_800D_A2(i_,j_); } inline void Bandai::Poke_M_800D_A2(Address,Data data)
            {
                eeprom->x24C02->Set( data & 0x20, data & 0x40 );
            }
            
            void Bandai::Poke_800D_C(void* p_,Address i_,Data j_) { static_cast<Bandai*>(p_)->Poke_M_800D_C(i_,j_); } inline void Bandai::Poke_M_800D_C(Address,Data data)
            {
                eeprom->x24C02->Set( data & 0x20, data & 0x40 );
