...
namespace Nes
{
    namespace Core
    {
        namespace Boards
        {
            ...
            Data Mmc3Waixing::Peek_ExRam(void* p_,Address i_) { return static_cast<Mmc3Waixing*>(p_)->Peek_M_ExRam(i_); } inline Data Mmc3Waixing::Peek_M_ExRam(Address address)
            {
                return exRam[address-0x5000];
            }
            
            void Mmc3Waixing::Poke_ExRam(void* p_,Address i_,Data j_) { static_cast<Mmc3Waixing*>(p_)->Poke_M_ExRam(i_,j_); } inline void Mmc3Waixing::Poke_M_ExRam(Address address,Data data)
            {
