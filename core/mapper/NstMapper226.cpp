...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper226::Poke_Prg(void* p_,Address i_,Data j_) { static_cast<Mapper226*>(p_)->Poke_M_Prg(i_,j_); } inline void Mapper226::Poke_M_Prg(Address address,Data data)
        {
