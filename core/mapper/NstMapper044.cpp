...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper44::Poke_A001(void* p_,Address i_,Data j_) { static_cast<Mapper44*>(p_)->Poke_M_A001(i_,j_); } inline void Mapper44::Poke_M_A001(Address,Data data)
        {
            data &= 0x7;
