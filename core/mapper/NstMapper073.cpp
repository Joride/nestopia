...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper73::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper73*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper73::Poke_M_8000(Address,Data data)
        {
            irq.Update();
            irq.unit.count = (irq.unit.count & 0xFFF0) | (data & 0xF) << 0;
        }
        
        void Mapper73::Poke_9000(void* p_,Address i_,Data j_) { static_cast<Mapper73*>(p_)->Poke_M_9000(i_,j_); } inline void Mapper73::Poke_M_9000(Address,Data data)
        {
            irq.Update();
            irq.unit.count = (irq.unit.count & 0xFF0F) | (data & 0xF) << 4;
        }
        
        void Mapper73::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Mapper73*>(p_)->Poke_M_A000(i_,j_); } inline void Mapper73::Poke_M_A000(Address,Data data)
        {
            irq.Update();
            irq.unit.count = (irq.unit.count & 0xF0FF) | (data & 0xF) << 8;
        }
        
        void Mapper73::Poke_B000(void* p_,Address i_,Data j_) { static_cast<Mapper73*>(p_)->Poke_M_B000(i_,j_); } inline void Mapper73::Poke_M_B000(Address,Data data)
        {
            irq.Update();
            irq.unit.count = (irq.unit.count & 0x0FFF) | (data & 0xF) << 12;
        }
        
        void Mapper73::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper73*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper73::Poke_M_C000(Address,Data data)
        {
            irq.Update();
        ...
        void Mapper73::Poke_D000(void* p_,Address i_,Data j_) { static_cast<Mapper73*>(p_)->Poke_M_D000(i_,j_); } inline void Mapper73::Poke_M_D000(Address,Data)
        {
            irq.Update();
