...
namespace Nes
{
    namespace Core
    {
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 0)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 249, "!!((mode & 0x3) == 0)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 0)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 263, "!!((mode & 0x3) == 0)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 0)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 276, "!!((mode & 0x3) == 0)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 1)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 291, "!!((mode & 0x3) == 1)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 1)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 333, "!!((mode & 0x3) == 1)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 1)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 347, "!!((mode & 0x3) == 1)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 1)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 359, "!!((mode & 0x3) == 1)") : (void)0);
        ...
        {
            (__builtin_expect(!(!!((mode & 0x3) == 2)), 0) ? __assert_rtn(__func__, "/Users/Jorrit/iOS/nestopia/core/mapper/NstMapper116.cpp", 371, "!!((mode & 0x3) == 2)") : (void)0);
        ...
        void Mapper116::Poke_4100(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_4100(i_,j_); } inline void Mapper116::Poke_M_4100(Address,Data data)
        {
            if (mode != data)
            {
                mode = data;
        ...
        void Mapper116::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper116::Poke_M_8000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
        ...
        void Mapper116::Poke_9000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_9000(i_,j_); } inline void Mapper116::Poke_M_9000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
        ...
        void Mapper116::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_A000(i_,j_); } inline void Mapper116::Poke_M_A000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
                case 0x0: Poke_Vrc2_8000( address, data ); break;
        ...
        void Mapper116::Poke_B000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_B000(i_,j_); } inline void Mapper116::Poke_M_B000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
        ...
        void Mapper116::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper116::Poke_M_C000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
                case 0x0: Poke_Vrc2_B000( address, data ); break;
        ...
        void Mapper116::Poke_D000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_D000(i_,j_); } inline void Mapper116::Poke_M_D000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
                case 0x0: Poke_Vrc2_B000( address, data ); break;
        ...
        void Mapper116::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_E000(i_,j_); } inline void Mapper116::Poke_M_E000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
                case 0x0: Poke_Vrc2_B000( address, data ); break;
        ...
        void Mapper116::Poke_F000(void* p_,Address i_,Data j_) { static_cast<Mapper116*>(p_)->Poke_M_F000(i_,j_); } inline void Mapper116::Poke_M_F000(Address address,Data data)
        {
            switch (mode & 0x3)
            {
                case 0x0: break;
