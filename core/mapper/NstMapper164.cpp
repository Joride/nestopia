...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper164::Poke_5000(void* p_,Address i_,Data j_) { static_cast<Mapper164*>(p_)->Poke_M_5000(i_,j_); } inline void Mapper164::Poke_M_5000(Address address,Data data)
        {
