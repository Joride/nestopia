...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper91::Poke_7002(void* p_,Address i_,Data j_) { static_cast<Mapper91*>(p_)->Poke_M_7002(i_,j_); } inline void Mapper91::Poke_M_7002(Address,Data)
        {
            irq.Update();
        ...
        void Mapper91::Poke_7003(void* p_,Address i_,Data j_) { static_cast<Mapper91*>(p_)->Poke_M_7003(i_,j_); } inline void Mapper91::Poke_M_7003(Address,Data)
        {
            irq.Update();
            irq.unit.Enable();
            irq.unit.SetLatch( 7 );
