...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper193::Poke_6000(void* p_,Address i_,Data j_) { static_cast<Mapper193*>(p_)->Poke_M_6000(i_,j_); } inline void Mapper193::Poke_M_6000(Address address,Data data)
        {
            ppu.Update();
