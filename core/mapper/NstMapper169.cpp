...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper169::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper169*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper169::Poke_M_8000(Address address,Data)
        {
            if (ctrl != address)
            {
                ctrl = address;
        ...
        void Mapper169::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper169*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper169::Poke_M_C000(Address address,Data)
        {
            address &= 0x7;
