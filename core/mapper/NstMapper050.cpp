...
namespace Nes
{
    namespace Core
    {
        ...
        Data Mapper50::Peek_wRom(void* p_,Address i_) { return static_cast<Mapper50*>(p_)->Peek_M_wRom(i_); } inline Data Mapper50::Peek_M_wRom(Address address)
        {
            return *prg.Source().Mem( (SIZE_128K-SIZE_8K-0x6000) + address );
        }
        
        void Mapper50::Poke_4020(void* p_,Address i_,Data j_) { static_cast<Mapper50*>(p_)->Poke_M_4020(i_,j_); } inline void Mapper50::Poke_M_4020(Address,Data data)
        {
        ...
        void Mapper50::Poke_4120(void* p_,Address i_,Data j_) { static_cast<Mapper50*>(p_)->Poke_M_4120(i_,j_); } inline void Mapper50::Poke_M_4120(Address,Data data)
        {
            irq.Update();
