...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper32::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper32*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper32::Poke_M_8000(Address,Data data)
        {
            regs[0] = data;
            UpdatePrg();
        }
        
        void Mapper32::Poke_9000(void* p_,Address i_,Data j_) { static_cast<Mapper32*>(p_)->Poke_M_9000(i_,j_); } inline void Mapper32::Poke_M_9000(Address,Data data)
        {
            regs[1] = data;
            UpdatePrg();
