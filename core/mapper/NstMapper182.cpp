...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper182::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Mapper182*>(p_)->Poke_M_A000(i_,j_); } inline void Mapper182::Poke_M_A000(Address,Data data)
        {
            command = data;
        }
        
        void Mapper182::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper182*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper182::Poke_M_C000(Address,Data data)
        {
            ppu.Update();
        ...
        void Mapper182::Poke_E003(void* p_,Address i_,Data j_) { static_cast<Mapper182*>(p_)->Poke_M_E003(i_,j_); } inline void Mapper182::Poke_M_E003(Address,Data data)
        {
            irq.Update();
