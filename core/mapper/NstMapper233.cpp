...
namespace Nes
{
    namespace Core
    {
        ...
        cartSwitches (prg.Source().Size() == SIZE_1024K ? new CartSwitches(c) : __null)
        {}
        ...
        void Mapper233::Poke_Prg(void* p_,Address i_,Data j_) { static_cast<Mapper233*>(p_)->Poke_M_Prg(i_,j_); } inline void Mapper233::Poke_M_Prg(Address,Data data)
        {
