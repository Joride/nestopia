...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper117::Poke_C001(void* p_,Address i_,Data j_) { static_cast<Mapper117*>(p_)->Poke_M_C001(i_,j_); } inline void Mapper117::Poke_M_C001(Address,Data data)
        {
            irq.Update();
            irq.unit.latch = data;
        }
        
        void Mapper117::Poke_C002(void* p_,Address i_,Data j_) { static_cast<Mapper117*>(p_)->Poke_M_C002(i_,j_); } inline void Mapper117::Poke_M_C002(Address,Data)
        {
            cpu.ClearIRQ();
        }
        
        void Mapper117::Poke_C003(void* p_,Address i_,Data j_) { static_cast<Mapper117*>(p_)->Poke_M_C003(i_,j_); } inline void Mapper117::Poke_M_C003(Address,Data)
        {
            irq.Update();
            irq.unit.count = irq.unit.latch;
        }
        
        void Mapper117::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mapper117*>(p_)->Poke_M_E000(i_,j_); } inline void Mapper117::Poke_M_E000(Address,Data data)
        {
            irq.Update();
