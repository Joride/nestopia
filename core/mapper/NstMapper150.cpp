...
namespace Nes
{
    namespace Core
    {
        ...
        cartSwitches (c.attribute == ATR_COPYRIGHT ? new CartSwitches : __null)
        {}
        ...
        Data Mapper150::Peek_4100(void* p_,Address i_) { return static_cast<Mapper150*>(p_)->Peek_M_4100(i_); } inline Data Mapper150::Peek_M_4100(Address)
        {
            return (~(command & 0x7) & 0x3F) ^ (cartSwitches ? cartSwitches->GetCopyright() : 0x1);
        }
        
        void Mapper150::Poke_4100(void* p_,Address i_,Data j_) { static_cast<Mapper150*>(p_)->Poke_M_4100(i_,j_); } inline void Mapper150::Poke_M_4100(Address,Data data)
        {
            command = data;
        }
        
        void Mapper150::Poke_4101(void* p_,Address i_,Data j_) { static_cast<Mapper150*>(p_)->Poke_M_4101(i_,j_); } inline void Mapper150::Poke_M_4101(Address,Data data)
        {
            uint banks[2] = {~0U,~0U};
