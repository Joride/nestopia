...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper51::Poke_6000(void* p_,Address i_,Data j_) { static_cast<Mapper51*>(p_)->Poke_M_6000(i_,j_); } inline void Mapper51::Poke_M_6000(Address,Data data)
        {
            mode = (data >> 3 & 0x2) | (data >> 1 & 0x1);
            UpdateBanks();
        }
        
        void Mapper51::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper51*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper51::Poke_M_8000(Address,Data data)
        {
            bank = data & 0xF;
            UpdateBanks();
        }
        
        void Mapper51::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper51*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper51::Poke_M_C000(Address,Data data)
        {
            bank = data & 0xF;
