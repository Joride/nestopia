...
namespace Nes
{
    namespace Core
    {
        ...
        Data Mapper40::Peek_6000(void* p_,Address i_) { return static_cast<Mapper40*>(p_)->Peek_M_6000(i_); } inline Data Mapper40::Peek_M_6000(Address address)
        {
            return *prg.Source().Mem( (SIZE_64K-SIZE_16K-0x6000) + address );
        }
        
        void Mapper40::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper40*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper40::Poke_M_8000(Address,Data)
        {
            irq.Update();
        ...
        void Mapper40::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Mapper40*>(p_)->Poke_M_A000(i_,j_); } inline void Mapper40::Poke_M_A000(Address,Data)
        {
            irq.Update();
            irq.unit.enabled = true;
        }
        
        void Mapper40::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mapper40*>(p_)->Poke_M_E000(i_,j_); } inline void Mapper40::Poke_M_E000(Address,Data data)
        {
