...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper146::Poke_4100(void* p_,Address i_,Data j_) { static_cast<Mapper146*>(p_)->Poke_M_4100(i_,j_); } inline void Mapper146::Poke_M_4100(Address,Data data)
        {
            ppu.Update();
