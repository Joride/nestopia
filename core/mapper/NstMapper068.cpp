...
namespace Nes
{
    namespace Core
    {
        ...
        doubleCassette (c.attribute == ATR_DOUBLECASSETTE ? new DoubleCassette : __null)
        {
        }
        ...
        void Mapper68::Poke_6000(void* p_,Address i_,Data j_) { static_cast<Mapper68*>(p_)->Poke_M_6000(i_,j_); } inline void Mapper68::Poke_M_6000(Address,Data data)
        {
            if (data == 0x00)
                prg.SwapBank<SIZE_16K,0x0000>( doubleCassette->Begin() );
        }
        
        Data Mapper68::Peek_8000(void* p_,Address i_) { return static_cast<Mapper68*>(p_)->Peek_M_8000(i_); } inline Data Mapper68::Peek_M_8000(Address address)
        {
        ...
        void Mapper68::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper68*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper68::Poke_M_C000(Address,Data data)
        {
            regs.nmt[0] = Regs::BANK_OFFSET | data;
            UpdateMirroring();
        }
        
        void Mapper68::Poke_D000(void* p_,Address i_,Data j_) { static_cast<Mapper68*>(p_)->Poke_M_D000(i_,j_); } inline void Mapper68::Poke_M_D000(Address,Data data)
        {
            regs.nmt[1] = Regs::BANK_OFFSET | data;
            UpdateMirroring();
        }
        
        void Mapper68::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mapper68*>(p_)->Poke_M_E000(i_,j_); } inline void Mapper68::Poke_M_E000(Address,Data data)
        {
            regs.ctrl = data;
            UpdateMirroring();
        }
        
        void Mapper68::Poke_F000(void* p_,Address i_,Data j_) { static_cast<Mapper68*>(p_)->Poke_M_F000(i_,j_); } inline void Mapper68::Poke_M_F000(Address,Data data)
        {
