...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper64::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper64*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper64::Poke_M_8000(Address,Data data)
        {
        ...
        void Mapper64::Poke_8001(void* p_,Address i_,Data j_) { static_cast<Mapper64*>(p_)->Poke_M_8001(i_,j_); } inline void Mapper64::Poke_M_8001(Address,Data data)
        {
        ...
        void Mapper64::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper64*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper64::Poke_M_C000(Address,Data data)
        {
            irq.Update();
            irq.unit.latch = data;
        }
        
        void Mapper64::Poke_C001(void* p_,Address i_,Data j_) { static_cast<Mapper64*>(p_)->Poke_M_C001(i_,j_); } inline void Mapper64::Poke_M_C001(Address,Data data)
        {
            irq.Update();
        ...
        void Mapper64::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mapper64*>(p_)->Poke_M_E000(i_,j_); } inline void Mapper64::Poke_M_E000(Address,Data)
        {
            irq.Update();
        ...
        void Mapper64::Poke_E001(void* p_,Address i_,Data j_) { static_cast<Mapper64*>(p_)->Poke_M_E001(i_,j_); } inline void Mapper64::Poke_M_E001(Address,Data)
        {
            irq.Update();
