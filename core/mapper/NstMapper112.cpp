...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper112::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper112*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper112::Poke_M_8000(Address,Data data)
        {
            command = data;
        }
        
        void Mapper112::Poke_A000(void* p_,Address i_,Data j_) { static_cast<Mapper112*>(p_)->Poke_M_A000(i_,j_); } inline void Mapper112::Poke_M_A000(Address,Data data)
        {
        ...
        void Mapper112::Poke_C000(void* p_,Address i_,Data j_) { static_cast<Mapper112*>(p_)->Poke_M_C000(i_,j_); } inline void Mapper112::Poke_M_C000(Address,Data data)
        {
            banks.chr[0] = data;
            UpdateChr();
        }
        
        void Mapper112::Poke_E000(void* p_,Address i_,Data j_) { static_cast<Mapper112*>(p_)->Poke_M_E000(i_,j_); } inline void Mapper112::Poke_M_E000(Address,Data data)
        {
            banks.chr[1] = data;
            UpdateChr();
            SetMirroringHV( data );
