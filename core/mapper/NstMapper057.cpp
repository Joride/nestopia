...
namespace Nes
{
    namespace Core
    {
        ...
        private:
            ...
            {
                typedef char Nestopia_assertion_at_line_109[(ATR_103 == 1 && ATR_GK_54 == 2 && ATR_GK_L01A == 3 && ATR_GK_L02A == 4 && ATR_GK_47 == 5) ? 1 : -1];
        ...
        Data Mapper57::Peek_6000(void* p_,Address i_) { return static_cast<Mapper57*>(p_)->Peek_M_6000(i_); } inline Data Mapper57::Peek_M_6000(Address)
        {
        ...
        void Mapper57::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper57*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper57::Poke_M_8000(Address,Data data)
        {
            regs[1] = data;
            ppu.Update();
            UpdateChr();
        ...
        void Mapper57::Poke_8800(void* p_,Address i_,Data j_) { static_cast<Mapper57*>(p_)->Poke_M_8800(i_,j_); } inline void Mapper57::Poke_M_8800(Address,Data data)
        {
            regs[0] = data;
