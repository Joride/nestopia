...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper183::Poke_B000(void* p_,Address i_,Data j_) { static_cast<Mapper183*>(p_)->Poke_M_B000(i_,j_); } inline void Mapper183::Poke_M_B000(Address address,Data data)
        {
            ppu.Update();
        ...
        void Mapper183::Poke_F000(void* p_,Address i_,Data j_) { static_cast<Mapper183*>(p_)->Poke_M_F000(i_,j_); } inline void Mapper183::Poke_M_F000(Address,Data data)
        {
            irq.Update();
            irq.unit.count[1] = (irq.unit.count[1] & 0xF0) | (data << 0 & 0x0F);
        }
        
        void Mapper183::Poke_F004(void* p_,Address i_,Data j_) { static_cast<Mapper183*>(p_)->Poke_M_F004(i_,j_); } inline void Mapper183::Poke_M_F004(Address,Data data)
        {
            irq.Update();
            irq.unit.count[1] = (irq.unit.count[1] & 0x0F) | (data << 4 & 0xF0);
        }
        
        void Mapper183::Poke_F008(void* p_,Address i_,Data j_) { static_cast<Mapper183*>(p_)->Poke_M_F008(i_,j_); } inline void Mapper183::Poke_M_F008(Address,Data data)
        {
            irq.Update();
        ...
        void Mapper183::Poke_F00C(void* p_,Address i_,Data j_) { static_cast<Mapper183*>(p_)->Poke_M_F00C(i_,j_); } inline void Mapper183::Poke_M_F00C(Address,Data)
        {
        }
