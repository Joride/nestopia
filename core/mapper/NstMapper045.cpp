...
namespace Nes
{
    namespace Core
    {
        ...
        void Mapper45::Poke_6000(void* p_,Address i_,Data j_) { static_cast<Mapper45*>(p_)->Poke_M_6000(i_,j_); } inline void Mapper45::Poke_M_6000(Address address,Data data)
        {
            if (exRegs[3] & 0x40)
            {
                ((void)0);
