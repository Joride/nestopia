...
namespace Nes
{
    namespace Core
    {
        ...
        private:
            ...
            {
                typedef char Nestopia_assertion_at_line_113[(ATR_STD == 0 && ATR_6_IN_1 == 1 && ATR_65_IN_1 == 2 && ATR_55_IN_1 == 3 && ATR_54_IN_1 == 4 && ATR_12_IN_1 == 5 && ATR_28_IN_1 == 6) ? 1 : -1];
        ...
        cartSwitches (CartSwitches::CanCreate(c) ? new CartSwitches(c) : __null)
        {}
        ...
        Data Mapper60::Peek_Prg(void* p_,Address i_) { return static_cast<Mapper60*>(p_)->Peek_M_Prg(i_); } inline Data Mapper60::Peek_M_Prg(Address address)
        {
            return !cartMode ? prg.Peek( address - 0x8000 ) : cartSwitches->GetMode();
        }
        
        void Mapper60::Poke_Prg(void* p_,Address i_,Data j_) { static_cast<Mapper60*>(p_)->Poke_M_Prg(i_,j_); } inline void Mapper60::Poke_M_Prg(Address address,Data)
        {
