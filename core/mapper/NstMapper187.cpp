...
namespace Nes
{
    namespace Core
    {
        ...
        Data Mapper187::Peek_5000(void* p_,Address i_) { return static_cast<Mapper187*>(p_)->Peek_M_5000(i_); } inline Data Mapper187::Peek_M_5000(Address)
        {
        ...
        void Mapper187::Poke_5000(void* p_,Address i_,Data j_) { static_cast<Mapper187*>(p_)->Poke_M_5000(i_,j_); } inline void Mapper187::Poke_M_5000(Address,Data data)
        {
            exLast = data;
        ...
        void Mapper187::Poke_5001(void* p_,Address i_,Data j_) { static_cast<Mapper187*>(p_)->Poke_M_5001(i_,j_); } inline void Mapper187::Poke_M_5001(Address,Data data)
        {
            if (suppressIrq)
            {
                suppressIrq = false;
        ...
        void Mapper187::Poke_8000(void* p_,Address i_,Data j_) { static_cast<Mapper187*>(p_)->Poke_M_8000(i_,j_); } inline void Mapper187::Poke_M_8000(Address address,Data data)
        {
            exMode = true;
            Mmc3::Poke_8000(this,address,data);
        }
        
        void Mapper187::Poke_8001(void* p_,Address i_,Data j_) { static_cast<Mapper187*>(p_)->Poke_M_8001(i_,j_); } inline void Mapper187::Poke_M_8001(Address address,Data data)
        {
            if (exMode)
                Mmc3::Poke_8001(this,address,data);
        }
        
        void Mapper187::Poke_8003(void* p_,Address i_,Data j_) { static_cast<Mapper187*>(p_)->Poke_M_8003(i_,j_); } inline void Mapper187::Poke_M_8003(Address,Data data)
        {
            exMode = false;
