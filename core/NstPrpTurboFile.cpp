...
namespace Nes
{
    namespace Core
    {
        namespace Peripherals
        {
            ...
            void TurboFile::Poke_4016(void* p_,Address i_,Data j_) { static_cast<TurboFile*>(p_)->Poke_M_4016(i_,j_); } inline void TurboFile::Poke_M_4016(Address address,Data data)
            {
                if (!(data & NO_RESET))
                {
                    pos = 0x00;
            ...
            Data TurboFile::Peek_4016(void* p_,Address i_) { return static_cast<TurboFile*>(p_)->Peek_M_4016(i_); } inline Data TurboFile::Peek_M_4016(Address address)
            {
                return p4016.Peek( address );
            }
            
            void TurboFile::Poke_4017(void* p_,Address i_,Data j_) { static_cast<TurboFile*>(p_)->Poke_M_4017(i_,j_); } inline void TurboFile::Poke_M_4017(Address address,Data data)
            {
                p4017.Poke( address, data );
            }
            
            Data TurboFile::Peek_4017(void* p_,Address i_) { return static_cast<TurboFile*>(p_)->Peek_M_4017(i_); } inline Data TurboFile::Peek_M_4017(Address address)
            {
