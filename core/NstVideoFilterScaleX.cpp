...
namespace Nes
{
    namespace Core
    {
        namespace Video
        {
            ...
            inline T* Renderer::FilterScaleX::Blit2xBorder(T* __restrict__ dst,const Input::Pixel* __restrict__ src,const Input::Palette& palette) const
            {
                {
                    dword p[4] =
                    {
            ...
            template<typename T,int PREV,int NEXT>
            inline T* Renderer::FilterScaleX::Blit3xBorder(T* __restrict__ dst,const Input::Pixel* __restrict__ src,const Input::Palette& palette) const
            {
                {
            ...
            template<typename T>
            inline T* Renderer::FilterScaleX::Blit3xCenter(T* __restrict__ dst,const Input::Pixel* __restrict__ src,const Input::Palette& palette) const
            {
            ...
            template<typename T,int PREV,int NEXT>
            inline T* Renderer::FilterScaleX::Blit2xLine(T* dst,const Input::Pixel* const src,const Input::Palette& palette,const long pad) const
            {
            ...
            template<typename T,int PREV,int NEXT>
            inline T* Renderer::FilterScaleX::Blit3xLine(T* dst,const Input::Pixel* const src,const Input::Palette& palette,const long pad) const
            {
